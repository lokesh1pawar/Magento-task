...
class Save extends \Techiq\Driver\Controller\Adminhtml\Items
{
            ...
            try {
                ...
                if(isset($_FILES['image']['name']) && $_FILES['image']['name'] != '') {
                    try{
                        ...
                        $destinationPath = $mediaDirectory->getAbsolutePath('techiq/driver');
                        ...
                        $imagePath = 'techiq_driver'.$result['file'];
                ...
                if ($this->getRequest()->getParam('back')) {
                    $this->_redirect('techiq_driver/*/edit', ['id' => $model->getId()]);
                    return;
                }
                ...
                if (!empty($id)) {
                    $this->_redirect('techiq_driver/*/edit', ['id' => $id]);
                } else {
                    $this->_redirect('techiq_driver/*/new');
                }
                return;
            } catch (\Exception $e) {
